...
class KalmanFilter:
    ...
    def __init__(self, dt, u_x, u_y, std_acc, x_std_meas, y_std_meas, start_x=0, start_y=0):
        self.dt = dt
        self.u_x = u_x
        self.u_y = u_y
        ...
        self.x_k = np.array([[start_x], [start_y], [0], [0]])
        self.x_k_ = np.array([[start_x], [start_y], [0], [0]])
